...
public class PsH3Ej33V2 {
	...
	public static void main(String[] args) {
		String vecMuchosNombres[] = {"Ana", "Jose", "Rafa", "Luis", "Adela", "Raul", "German",
				...
				"Pilar", "Carmen", "Teresa", "Lolo", "Perico"};//21 elementos
		String arrayNombres[] = new String[20];
		int indice, indiceAzar;
		for( indice = 0; indice < 20; indice++){// indice de arrayNombres
			indiceAzar = (int)Math.floor(Math.random()*21);// para elegir un nombre al azar de vecMuchosNombres
